...
public class colorDetectionAuto extends OpenCvPipeline {
     ...
     */
    public colorDetectionAuto(int width) {
        this.width = width;
    }
    ...
    public Mat processFrame(Mat input) {
        ...
        Scalar lowHSV = new Scalar(240, 98, 21); // lower bound HSV for yellow
        Scalar highHSV = new Scalar(240, 99, 87); // higher bound HSV for yellow
        Mat thresh = new Mat();
        ...
        Mat edges = new Mat();
        Imgproc.Canny(thresh, edges, 640, 360);
